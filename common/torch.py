...
class CheckPointManager(object):
    ...
    def save(self, model: torch.nn.Module, optimizer: Optimizer, step: int, 
            score: float = 0.0):
    ...
    def load(self, save_path, model: torch.nn.Module = None, optimizer: Optimizer = None, distributed: bool=False):
