...
label_yaml_config = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'semantic-kitti.yaml' )
...
class KittiDataset(Dataset):
    ...
    Params:
        ...
        ignore_label
    '''
    def __init__(self, root, split, transform, ignore_label=None, augment = 1.0 ):
